     ...
     <el-row>
        ...
        <el-form-item   v-if="flag=='yonghu'"  label="联系电话" prop="lianxidianhua">
          <el-input v-model="ruleForm.lianxidianhua"               placeholder="联系电话" clearable></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item   v-if="flag=='yonghu'"  label="联系邮箱" prop="lianxiyouxiang">
          <el-input v-model="ruleForm.lianxiyouxiang"               placeholder="联系邮箱" clearable></el-input>
        </el-form-item>
      </el-col>
...
export default {
  ...
  methods: {
        ...
        return
                                                                        ...
                                                                        if( 'yonghu' ==this.flag && this.ruleForm.lianxiyouxiang&&(!isEmail(this.ruleForm.lianxiyouxiang))){
        this.$message.error(`联系邮箱应输入邮箱格式`);
        return
      }
                                                                                                                              this.$http({
