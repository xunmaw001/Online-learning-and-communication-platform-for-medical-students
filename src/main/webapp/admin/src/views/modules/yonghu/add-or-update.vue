          ...
          <el-form-item class="input" label="联系电话" prop="lianxidianhua">
              <el-input v-model="ruleForm.lianxidianhua" 
                placeholder="联系电话" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="联系邮箱" prop="lianxiyouxiang">
          <el-input v-model="ruleForm.lianxiyouxiang" 
              placeholder="联系邮箱" clearable  :readonly="ro.lianxiyouxiang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="联系邮箱" prop="lianxiyouxiang">
              <el-input v-model="ruleForm.lianxiyouxiang" 
                placeholder="联系邮箱" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.lianxidianhua = true;
            continue;
	            	            ...
	            	            if(o=='lianxiyouxiang'){
            this.ruleForm.lianxiyouxiang = obj[o];
	    this.ro.lianxiyouxiang = true;
            continue;
          }
	                    }
                                                                                                                              }
