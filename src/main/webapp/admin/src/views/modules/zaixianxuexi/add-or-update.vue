      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="课程编号" prop="kechengbianhao">
          <el-input v-model="ruleForm.kechengbianhao" 
              placeholder="课程编号" clearable  :readonly="ro.kechengbianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="课程编号" prop="kechengbianhao">
              <el-input v-model="ruleForm.kechengbianhao" 
                placeholder="课程编号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="课程类别" prop="kechengleibie">
          <el-select v-model="ruleForm.kechengleibie" placeholder="请选择课程类别">
            <el-option
                v-for="(item,index) in kechengleibieOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="课程类别" prop="kechengleibie">
	      <el-input v-model="ruleForm.kechengleibie"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.kechengfengmian" label="课程封面" prop="kechengfengmian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.kechengfengmian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="课程详情" prop="kechengxiangqing">
          <file-upload
          tip="点击上传课程详情"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.kechengxiangqing?ruleForm.kechengxiangqing:''"
          @change="kechengxiangqingUploadChange"
          ></file-upload>
        </el-form-item> 
        <div v-else>
          <el-form-item v-if="ruleForm.kechengxiangqing" label="课程详情" prop="kechengxiangqing">
            <el-button type="text" size="small" @click="download(ruleForm.kechengxiangqing)">预览</el-button>
          </el-form-item>
        </div>
      </el-col>
                                                                                                                        </el-row>
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                              ...
                                                                              this.kechengleibieOptions = "基础医学,临床医学,口腔医学,中医学,药学".split(',')
                                                                                                                      },
                                                                        // 多级联动参数
                                                                                            info(id) {
      this.$http({
    ...
    back() {
      ...
      this.parent.contentStyleChange();
				...
				this.addEditUploadStyleChange()
                                ...
                                kechengxiangqingUploadChange(fileUrls) {
                this.ruleForm.kechengxiangqing = fileUrls;
				this.addEditUploadStyleChange()
            },
                                                	addEditStyleChange() {
	  this.$nextTick(()=>{
