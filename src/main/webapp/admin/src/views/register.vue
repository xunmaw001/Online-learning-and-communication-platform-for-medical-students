  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(251, 0, 29, 0.73);fontSize:28px;">医学生在线学习交流平台注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.lianxidianhua" autocomplete="off" placeholder="联系电话" type="text" />
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.lianxiyouxiang" class="input" type="text" placeholder="联系邮箱">
			   </div>
			 </div> -->
			<el-form-item label="联系邮箱" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.lianxiyouxiang" autocomplete="off" placeholder="联系邮箱" type="text" />
			</el-form-item>
...
export default {
  ...
  methods: {
    ...
    login() {
        ...
        this.$message.error(`联系邮箱应输入邮件格式`);
        return
      }
                                                                                                                              this.$http({
